...
Artifact FIREBASE_CORE_ARTIFACT                    = new Artifact ("Firebase.Core",                   "6.10.3.11",        "9.0", ComponentGroup.Firebase, csprojName: "Core");
...
Artifact GOOGLE_MOBILE_ADS_ARTIFACT   = new Artifact ("Google.MobileAds",   "7.65.0.11",   "9.0", ComponentGroup.Google, csprojName: "MobileAds");
